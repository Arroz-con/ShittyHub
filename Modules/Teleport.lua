...
function Teleport.PlaceFloorAtCampSite()
	...
	local part = Instance.new("Part")
	part.Position = campsite.Position + Vector3.new(0, (campsite/2) + 5, 0)
	part.Size = Vector3.new(200, 2, 200)
	part.Anchored = true
    part.Transparency = 1
...
function Teleport.PlaceFloorAtBeachParty()
	...
	local part = Instance.new("Part")
	part.Position = workspace.StaticMap.Beach.BeachPartyAilmentTarget.Position + Vector3.new(-200, 0, 40)
	part.Size = Vector3.new(200, 2, 200)
	part.Anchored = true
    part.Transparency = 1
...
function Teleport.FarmingHome()
	...
	Player.Character.HumanoidRootPart.CFrame = workspace.FarmingHomeLocation.CFrame * CFrame.new(0, 10, 0)
